...
This directory captures the exact packages installed on IONOS staging and the public WordPress site on 2026-09-25. It is a release snapshot of the live RC25 Names v0.3.0 + CHSOS pilot UI4 runtime with ACMS-C/U recipe candidates and computed A/B previews added. The existing RC24 source build is not used for this release because it does not contain the installed RC25 Names v0.3.0 and UI4 changes.
...
sha256sum releases/rc26-acms/work/rc26-preserved/*.zip
```
