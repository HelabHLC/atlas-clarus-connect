...
function atlas_clarus_hover_shortcode($atts=array()) {
    ...
    return sprintf(
        '<section id="%1$s" class="atlas-clarus-library" aria-label="%9$s" data-colors-url="%2$s" data-views-url="%3$s" data-default-view="%4$s" data-per-page="%5$d" data-show-status="%6$s" data-show-search="%7$s" data-show-library-selector="%8$s" data-wheel-url="%11$s" data-basis23-url="%12$s" data-basis23-version="%13$s" data-name-index-url="%14$s" data-acms-recipes-url="%15$s"><div class="atlas-clarus-loading" role="status">%10$s</div></section>',
        ...
        esc_url(add_query_arg('ver', atlas_clarus_hover_asset_version('data/acms-solid-recipe-candidates.json'), ATLAS_CLARUS_HOVER_URL.'data/acms-solid-recipe-candidates.json'))
    );
}
