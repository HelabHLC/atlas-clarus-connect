...
(DIST/'docs').mkdir()
for name in ('index.html','app.css','basis23-recipes.js','palette-export.js','image-sampling.js','print-handoff.js','print-ui.js','app.js'):
...
for module in ('print-handoff.js','print-ui.js'):
