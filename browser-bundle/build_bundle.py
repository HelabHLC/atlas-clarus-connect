...
ZIP=HERE/'dist'/'ATLAS_Clarus_Browser_Bundle_v0.2.0-rc4.zip'
...
html=html.replace('v0.2.0-rc1','v0.2.0-rc4')
...
manifest={'bundle':'ATLAS Clarus Browser Bundle','version':'0.2.0-rc4','status':'READY_PENDING_AUDIT','workflow':'ATLAS Clarus v3.4.0','master_sha256':MASTER,'master_rows':13283,'row_id_base':0,'offline_entrypoint':'index.html','entrypoint_packaging':'SELF_CONTAINED_SINGLE_FILE','observed_library_views':17,'a_prime_v04_logic':'UNCHANGED','measured_qc_status':'NOT_MEASURED'}
