...
ZIP=HERE/'dist'/'ATLAS_Clarus_Browser_Bundle_v0.2.0-rc6.zip'
...
manifest={'bundle':'ATLAS Clarus Browser Bundle','version':'0.2.0-rc6','status':'READY_PENDING_AUDIT','workflow':'ATLAS Clarus v3.4.0','master_sha256':MASTER,'master_rows':13283,'row_id_base':0,'offline_entrypoint':'index.html','entrypoint_packaging':'SELF_CONTAINED_SINGLE_FILE','observed_library_views':17,'shared_palette_workspace':'HOVER_AND_WHEEL','palette_persistence':'LOCAL_BROWSER_ONLY','palette_exports':['ASE','FIGMA_TOKENS_JSON','CSS','CLARUS_JSON'],'app_connections_format':'CAN_VERIFIED_NEEDED','a_prime_v04_logic':'UNCHANGED','measured_qc_status':'NOT_MEASURED'}
