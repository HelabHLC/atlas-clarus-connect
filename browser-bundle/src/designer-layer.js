...
function searchText(r){return r?[r.designer_name_en,r.colour_family,r.hue_character,r.lightness_character,r.chroma_character,r.temperature].join(' ').toUpperCase():''}
